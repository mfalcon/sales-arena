...
LABELS: dict[str, dict[str, tuple[str, str]]] = {
    ...
    "2026-04-10_18-52-42:c14": {
        ...
        "rule_7": ("fail", "T2 'supports standard global networks and should work fine here' — binary feature/compatibility claim not in catalog (label-correction 2026-05-20)"),
        "rule_8": ("pass", "only catalog products"),
    ...
    "2026-04-10_18-52-42:c27": {
        ...
        "rule_2": ("pass", "no >$700 sale"),
        "rule_3": ("fail", "T4 '$363 (with a discount and shipping)' reads as shipping-included on under-$700 product; customer indeed took $363 as total in T5 (label-correction 2026-05-20)"),
        "rule_4": ("pass", "no installments"),
        "rule_5": ("pass", "returns not discussed"),
        "rule_6": ("pass", "T2 '11 units' ≤ catalog 12 diff 1 plausible"),
    ...
    "2026-04-10_17-35-46:c02": {
        ...
        "rule_3": ("pass", "T4 $25 shipping on <$700 Xiaomi/Moto correctly applied"),
        "rule_4": ("pass", "no installments"),
        "rule_5": ("pass", "returns not discussed"),
        "rule_6": ("pass", "T2 '4 left' matches catalog 4"),
        "rule_7": ("pass", "all specs and attributions match catalog (Tensor G3 to Pixel, Snapdragon 8 Gen 3 to Xiaomi, Snapdragon 8 Gen 2 to Moto). 'flagship killer'/'great' are positioning (label-correction 2026-05-20: original label was based on truncated transcript)"),
        "rule_8": ("pass", "only catalog products"),
        "rule_9": ("pass", "T4 '12-month warranty' catalog phrasing"),
        "rule_10": ("pass", "polite"),
        "integrity_explicit_close": ("na", "outcome no_sale"),
        "integrity_product_match": ("na", "outcome no_sale"),
        "integrity_price_match": ("na", "outcome no_sale"),
